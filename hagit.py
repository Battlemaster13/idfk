...
pygame.display.set_caption("baljeet.hodi")
background_music = pygame.mixer.Sound("music3.mp3")
...
laser_image = pygame.image.load("—Pngtree—light light effect rays laser_3840309.png")
  ...
  for event in pygame.event.get():
    if event.type == pygame.QUIT:
      ...
      if event.key == pygame.K_SPACE:
        shot_sound = pygame.mixer.Sound("laser.sound.mp3")
        pygame.mixer.music.load("laser.sound.mp3")
